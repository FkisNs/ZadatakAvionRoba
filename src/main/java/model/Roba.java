...
public class Roba {
    ...
    @DatabaseField(foreign = true, foreignAutoRefresh = true, canBeNull = false, columnName = "avion_id")
    private Avion avion;

    public Roba() {
    }

    public Roba(int id, String naziv, String opis, Double tezina, Avion avion) {
        this.id = id;
        this.naziv = naziv;
        this.opis = opis;
        this.tezina = tezina;
